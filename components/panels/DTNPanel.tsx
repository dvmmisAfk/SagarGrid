...
export default function DTNPanel() {
  ...
  const show = isolatedBoats.length > 0 || activeMessages.length > 0;
    ...
    <AnimatePresence>
      {show && (
        <motion.div
          ...
          className="absolute left-4 bottom-24 z-[1000] w-56"
        >
          <div
          ...
          >
            ...
            <div className="font-mono text-[10px] text-white/40 mb-3 leading-relaxed">
              No live mesh link. Message is buffered and relayed when the next boat drifts into
              range.
            </div>
